MAIN_QUEST_STAGES = 
{
    ...
    :MEET_TAMARIND_AT_DOCKS         => "Tamarind is waiting for you at the Casaba Villa dock, where your boat is docked.",
    ...
    :FIND_CHAMPIONSHIP_TOURNAMENT   => "Find the Tournament Grounds, site of the Makyan Championship. The Grounds can be found north of the Battle Plaza in the center of Prizca.",
    :WIN_CHAMPIONSHIP_TOURNAMENT    => "Win the Makyan Championship being hosted in Prizca's Tournemtn Grounds. Prove that you are the best trainer in Makya!",
