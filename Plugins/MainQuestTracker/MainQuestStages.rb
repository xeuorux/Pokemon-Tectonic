MAIN_QUEST_STAGES = 
{
    ...
    :FIND_FOURTH_GYM                => "Find the fourth gym leader, located in Velenz. Velenz is west of the Wet Walkways, which can be found by passing through either Svait or the Jungle Path.",
    ...
    :FIND_DIGIT_SLIPS               => "You found Noel in the south east of Velenz, down a ladder. To unlock the door to his room, you must find at least four Digit Slips somewhere around Velenz. Velenz is west of the Wet Walkways.",
