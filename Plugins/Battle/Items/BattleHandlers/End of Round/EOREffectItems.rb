...
_INTL("{1} was burned by the {2}! {3}", battler.pbThis, getItemName(battler.baseItem), BURNED_EXPLANATION))
    }
)
...
BattleHandlers::EOREffectItem.add(:POISONORB,
  ...
  _INTL("{1} was poisoned by the {2}! {3}!", battler.pbThis, getItemName(battler.baseItem), POISONED_EXPLANATION))
  }
)
...
BattleHandlers::EOREffectItem.add(:FROSTORB,
  ...
  _INTL("{1} was afflicted by the {2}! {3}!", battler.pbThis, getItemName(battler.baseItem), FROSTBITE_EXPLANATION))
  }
)
