...
class PokeBattle_Move_017 < PokeBattle_Move
  ...
  def getScore(score,user,target)
    ...
    score = getBurnMoveScore(score,user,target,policies,statusMove?)
    score = getFrostbiteMoveScore(score,user,target,policies,statusMove?)
    score = getNumbMoveScore(score,user,target,policies,statusMove?)
    return score
  end
end
