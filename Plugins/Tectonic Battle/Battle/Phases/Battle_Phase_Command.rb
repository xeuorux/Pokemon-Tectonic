class PokeBattle_Battle
    ...
    def pbCommandPhase
        ...
        if @turnCount == 0 && @playerAmbushing
            ...
            pbDisplayWithFormatting(_INTL("\\wm\\ssYour foe was <imp>ambushed</imp>! You get a free turn!"))
        ...
        if @turnCount == 0 && @foeAmbushing
            ...
            pbDisplayWithFormatting(_INTL("\\wm\\ssYou were <imp>ambushed</imp>! The foe gets a free turn!"))
            eachSameSideBattler do |b|
                b.extraMovesPerTurn = 0
            end
        else
