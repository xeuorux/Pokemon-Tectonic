...
class Pokemon
    ...
    def legalItems?(itemSet, showMessages = false)
      ...
      return true if hasAbility?(:WELLEQUIPPED)
    end
    ...
    def trait1
      ...
      while @Trait1.nil? || @Trait1 == @Trait2 || @Trait1 == @Trait3
        @Trait1 = GameData::Trait.getRandomTrait
      end
      return @Trait1
    end
    ...
    def trait2
      ...
      while @Trait2.nil? || @Trait2 == @Trait1 || @Trait2 == @Trait3
        @Trait2 = GameData::Trait.getRandomTrait
      end
      return @Trait2
    end
    ...
    def trait3
      ...
      while @Trait3.nil? || @Trait3 == @Trait1 || @Trait3 == @Trait2
        @Trait3 = GameData::Trait.getRandomTrait
      end
      return @Trait3
    end
    ...
    def like
      ...
      while @Like.nil? || @Like == @Dislike
        @Like = GameData::Like.getRandomLike
      end
      return @Like
    end
    ...
    def dislike
      ...
      while @Dislike.nil? || @Dislike == @Like
        @Dislike = GameData::Dislike.getRandomDislike
      end
      return @Dislike
    end
