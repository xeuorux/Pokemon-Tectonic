...
class PokeBattle_ZMove < PokeBattle_Move
    ...
    #-----------------------------------------------------------------------------
    def self.from_base_move(battle, battler, move)
        ...
        className    = format("PokeBattle_Move_%s", moveFunction)
        return Object.const_get(className).new(battle, move, newMove) if Object.const_defined?(className)
        return PokeBattle_ZMove.new(battle, move, newMove)
    end
    ...
    def pbUse(battler, simplechoice = nil, specialUsage = false)
        ...
        zchoice = simplechoice if simplechoice
    ...
    #=============================================================================
    def self.from_status_move(battle, move, attacker)
