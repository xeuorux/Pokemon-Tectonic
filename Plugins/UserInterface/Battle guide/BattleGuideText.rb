...
AVATARS_HASH = {
    ...
    _INTL("Stat-Modifying") => _INTL("Avatars are only half as affected by in-battle stat step changes. For example, their attack is only given a 25% increase from a +1 boost."),
