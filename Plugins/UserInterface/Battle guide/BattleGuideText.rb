...
STATUS_CONDITIONS_HASH = {
    ...
    "Frostbite" => "When frostbitten, a Pokémon deals 33% less special damage, and loses 1/8th HP every turn. Ice- and Flying-types do the most frostbiting. Ice is immune.",
