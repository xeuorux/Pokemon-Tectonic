...
STATUS_CONDITIONS_HASH = {
    ...
    "Burn" => "When burned, a Pokémon deals 33% less physical damage, and loses 1/8th HP every turn. Fire- and Ghost-types do the most burning. Fire is immune.",
    "Poison" => "When poisoned, a Pokémon deals 33% less special damage, and loses 1/8th HP every turn. Poison- and Grass-types do the most poisoning. Poison/Steel are immune.",
    ...
    "Flustered" => "When flustered, a Pokemon will hit itself with its own Atk stat after using a damaging move. Psychic- and Bug-types do the most flustering. Psychic is immune.",
    "Mystified" => "When mystified, a Pokemon will hit itself with its own Sp. Atk stat after using a damaging move. Fairy- and Dark-types do the most mystifying. Fairy is immune.",
