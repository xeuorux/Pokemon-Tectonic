...
STATS_HASH = {
    ...
    _INTL("Style Points") => _INTL("Style Points are numbers which you can customize to change your Pokémon's stats (except HP). Style Points show as blue numbers on the stat page of the summary."),
...
ABILITIES_HASH = {
    ...
    _INTL("Conditional Abilities") => _INTL("Many abilities only do things under certain circumstances. Buiding around Weather and Terrain-synergy abilities is a common strategy."),
...
AVATARS_HASH = {
    ...
    _INTL("Primeval Moves") => _INTL("When about half damaged, most avatars will use their one Primeval Move! Primeval Moves are powered up versions of other moves, which also change the Avatars type."),
