...
class SpriteWindow < Window
    ...
    def privRefresh(changeBitmap=false)
      ...
      begin
        ...
        newErrorMessage = ""
        newErrorMessage += "The pesky disposed sprite error has occurred!\r\n"
        newErrorMessage += "Windowskin disposed: #{@_windowskin.disposed?}\r\n"
        newErrorMessage += "#{caller}\r\n#{$!}"
        
        raise $!, newErrorMessage, $!.backtrace
      end
