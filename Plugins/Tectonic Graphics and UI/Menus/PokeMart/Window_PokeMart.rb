...
class Window_PokemonMart < Window_DrawableCommand
    def initialize(stock, adapter, x, y, width, height, viewport = nil)
      ...
      @baseColor   = $PokemonSystem.dark_mode == 0 ? Color.new(248,248,248) : Color.new(88,88,80)
      @shadowColor = $PokemonSystem.dark_mode == 0 ? Color.new(104,104,104) : Color.new(168,184,184)
      self.windowskin = nil
    end
