...
module GameData
    class Ability
        ...
        SAND_ABILITIES = %i[SANDSTREAM SANDBURST SANDRUSH SANDSHROUD DESERTSPIRIT SANDDRILLING SANDDEMON
                            IRONSTORM SANDSTRENGTH SANDPOWER CRAGTERROR DESERTSCAVENGER DESERTARMOR
                            METEORIC]
        ...
        HAIL_ABILITIES = %i[SNOWWARNING FROSTSCATTER ICEBODY SNOWSHROUD BLIZZBOXER SLUSHRUSH ICEFACE
                            ...
                            POLARHUNTER WINTERWISDOM METEORIC]
        ...
        HAZARD_IMMUNITY_ABILITIES = %i[AQUASNEAK NINJUTSU SURVIVALIST HYPERSPEED]

        MOLD_BREAKING_ABILITIES = %i[MOLDBREAKER TERAVOLT TURBOBLAZE CLEAVING STRAIGHTAHEAD JUGGERNAUT]
